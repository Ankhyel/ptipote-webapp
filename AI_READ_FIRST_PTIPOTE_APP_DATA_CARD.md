...
- Une mission **Recherche** menée depuis la Lisière alimente désormais ce même savoir si la Tour de recherche est active : **+5 % par heure**. Sans Tour, le rapport explique que les données du biome ne peuvent pas être comprises. Sous **50 %** de connaissances, les chances de trouver des Capsules durant les missions sont divisées par deux et l’interface l’indique avant le départ.
...
- Les protections personnelles sont déterminées à l’annonce de la météo globale : **Tenue ombragée**, **Tenue anti-pluie** et **Tenue filtrante** sont les supports durables. Le consommable compatible est utilisé avant la tenue : **Réflecteur thermique** (chaleur), **Couche imperméabilisante** (pluie) et **Filtre personnel** (nuage toxique). Une météo normale/moyenne/forte consomme respectivement 1/2/3 usages ; un consommable neuf et une tenue neuve apportent donc 20 protections normales. Sans consommable, la tenue absorbe directement l’usure. Sans tenue, le consommable ne protège pas seul. Leur durabilité est diminuée par événement, jamais par heure. Un manque applique un modificateur temporaire retiré à la fin de l’événement.
- L’**Installation filtrante** est structurelle et possède sa réserve locale de **Cartouches de filtration**. Les cartouches sont consommées en priorité lors d’un nuage toxique ; sans réserve suffisante, l’installation ne fournit plus sa réduction pour cet événement. Les cartouches restent distinctes du Filtre personnel.
- Le **Kit de réparation domestique** et le **Dispositif de régénération** sont des crafts de la section **Structures** de l’Atelier, avec leurs Patterns Kernel correspondants. Ils restent des objets physiques stockables, respectivement dédiés à la Viabilité et à la Biomasse.
...
- Le **Biofermenteur mycélien** produit en continu 12 / 18 / 24 / 30 Organique par jour aux niveaux 1 à 4. Les fractions sont conservées hors ligne dans sa réserve organique verte, puis récoltées par le joueur ; une réserve pleine suspend la production sans crédit invisible. Sa construction dure 1 h au niveau 1, puis 2 h, 3 h et 4 h pour les améliorations ; **Forêt comestible** dure 1 h.
- Sa **Lithoculture** est une cuve grise de `30 + 10/niveau` Minéraux : chaque tranche de 10 Minéraux lance un cycle d’1 h et produit 3 Organique dans la réserve verte. Les Déchets ne sont pas convertis en Mycélium et il n’existe pas de recette générique Déchets → Organique.
- Le **Bassin de calcium**, réservé au Biofermenteur du **Bassin minéral**, ajoute des réserves d’eau, d’Organique et de Minéral. La pluie remplit l’eau à 2 / 5 / 10 par heure (modérée / forte / sévère). Chaque heure, au moins 10 Minéraux dans la cuve donnent 1 Minéral par tranche de 10, sans les consommer ; le cycle consomme une fois 1 Organique et 2 Eau. Chaque P’TIBUG `mineur` ou `lithoculture` actif dans le biome ajoute +1 Minéral/h quand le Bassin produit. Toutes ces valeurs sont réglables dans la configuration Lisière du Dashboard.
...
- Le camp génère des Déchets domestiques continus à partir des habitants, P’TIBOTES et P’TIBUG actifs. Les sources techniques peuvent appeler `registerWasteGeneration`; les rapports quotidiens sont agrégés, découpés par jour même hors ligne, visibles au Recycleur et résumés dans le Journal.
- Le Recycleur conserve sa capacité et sa vitesse. Son orientation standard est **40 % Organique / 40 % Minéral / 20 % Eau** ; l’orientation biologique est **60 % / 20 % / 20 %**. Le Mycélium n’est jamais une sortie du Recycleur. Le ratio est enregistré au cycle afin qu’un changement de module ne réécrive jamais un batch lancé.

## Mycélium — biomes et Biofermenteur

- La ressource canonique est `Mycélium`. Les récoltes, l’inventaire, les crafts Tier 2, le Kit de régénération, les P’TIBUG et le Biofermenteur utilisent cette même clé ; aucune seconde ressource fongique n’est créée.
- Les identifiants techniques de biome restent stables. Les noms affichés sont : **Forêt humide** (ancien Sous-bois), **Haut Refuge** (ancien Montagne), **Savane tropicale** (ancien Plaine) et **Forêt sèche** (ancien Colline). Mangrove, Bassin minéral, Littoral et Semi-désert gardent leurs noms. Mangrove, Haut Refuge, Littoral et Semi-désert restent verrouillés : leurs données ne constituent pas un déblocage.
- Richesse naturelle en Mycélium : rich = Forêt humide, Mangrove, Haut Refuge ; medium = Savane tropicale, Forêt sèche ; none = Bassin minéral, Littoral, Semi-désert. La récolte de Mycélium dépend de la Biomasse existante et les rendements de référence sont `0 / 2 / 3` par cycle (none / medium / rich), configurables dans le Dashboard.
- Le Type P’TIBOTE **Mycélien** accorde `+50 %` de Mycélium lors d’une récolte naturelle compatible. C’est un bonus du Type, préparé pour les futurs Noyaux Protocole, et non un bonus de stock ou de bâtiment.
