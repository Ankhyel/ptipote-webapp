...
const defaultCraftConfig = CraftConfig(
  recipes: <CraftRecipe>[
    ...
    CraftRecipe(
      id: 'filterSuit',
      displayName: 'Tenue filtrante',
      craftSection: CraftSection.atelier,
      ingredients: <String, int>{'Filtre': 1, 'Organique': 3, 'Minéral': 2},
      contextIngredients: <String, int>{},
      cuisineLevel: 0,
      atelierLevel: 1,
      kernelTrustLevel: 2,
    ...
    CraftRecipe(
      id: 'waterproofLayer',
      displayName: 'Couche imperméabilisante',
      craftSection: CraftSection.atelier,
      ingredients: <String, int>{'Organique': 2, 'Minéral': 1},
      contextIngredients: <String, int>{},
      cuisineLevel: 0,
      ...
      builderLevel: 2,
      restorerLevel: 1,
      resultItem: 'Couche imperméabilisante',
      resultAmount: 1,
      isConsumable: false,
      hungerRestore: 0,
      vitalityRestore: 0,
    ...
    CraftRecipe(
      id: 'thermalReflector',
      displayName: 'Réflecteur thermique',
      craftSection: CraftSection.atelier,
      ingredients: <String, int>{'Organique': 2, 'Minéral': 2},
      contextIngredients: <String, int>{},
      cuisineLevel: 0,
      atelierLevel: 1,
      kernelTrustLevel: 2,
      ...
      builderLevel: 2,
      restorerLevel: 1,
      resultItem: 'Réflecteur thermique',
      resultAmount: 1,
      isConsumable: false,
      hungerRestore: 0,
      vitalityRestore: 0,
    ...
    CraftRecipe(
      id: 'personalFilter',
      displayName: 'Filtre personnel',
      craftSection: CraftSection.atelier,
      ingredients: <String, int>{'Filtre': 1, 'Organique': 1},
      contextIngredients: <String, int>{},
      cuisineLevel: 0,
      atelierLevel: 1,
      kernelTrustLevel: 2,
    ...
    CraftRecipe(
      id: 'filterInstallation',
      displayName: 'Installation filtrante',
      craftSection: CraftSection.atelier,
      ingredients: <String, int>{'Filtre': 1, 'Organique': 4, 'Minéral': 4},
      contextIngredients: <String, int>{},
      cuisineLevel: 0,
      atelierLevel: 1,
      kernelTrustLevel: 3,
      ...
      builderLevel: 1,
      restorerLevel: 2,
      resultItem: 'Installation filtrante',
      resultAmount: 1,
      isConsumable: false,
      hungerRestore: 0,
      vitalityRestore: 0,
    ...
    CraftRecipe(
      ...
      builderLevel: 1,
      restorerLevel: 1,
      resultItem: 'Protection thermique P’TIPOTE',
      resultAmount: 1,
      isConsumable: false,
      hungerRestore: 0,
      vitalityRestore: 0,
    ...
    CraftRecipe(
      ...
      builderLevel: 1,
      restorerLevel: 1,
      resultItem: 'Protection pluie/humidité P’TIPOTE',
      resultAmount: 1,
      isConsumable: false,
      hungerRestore: 0,
      vitalityRestore: 0,
    ...
    CraftRecipe(
      ...
      builderLevel: 1,
      restorerLevel: 1,
      resultItem: 'Protection filtrante/toxique P’TIPOTE',
      resultAmount: 1,
      isConsumable: false,
      hungerRestore: 0,
      vitalityRestore: 0,
    ...
    CraftRecipe(
      id: 'repairKit',
      displayName: 'Kit de réparation domestique',
      craftSection: CraftSection.atelier,
      ingredients: <String, int>{'Organique': 1, 'Minéral': 3},
      contextIngredients: <String, int>{},
      cuisineLevel: 0,
      atelierLevel: 1,
      kernelTrustLevel: 1,
      ...
      builderLevel: 1,
      restorerLevel: 1,
      resultItem: 'Kit de réparation domestique',
      resultAmount: 1,
      isConsumable: false,
      hungerRestore: 0,
      vitalityRestore: 0,
    ...
    CraftRecipe(
      id: 'biomassRegenerator',
      displayName: 'Dispositif de régénération',
      craftSection: CraftSection.atelier,
      ingredients: <String, int>{
        'Organique': 10,
        'Minéral': 10,
      ...
      builderLevel: 1,
      restorerLevel: 1,
      resultItem: 'Dispositif de régénération',
      resultAmount: 1,
      isConsumable: false,
      hungerRestore: 0,
      vitalityRestore: 0,
