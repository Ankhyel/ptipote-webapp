...
const MarketConfig defaultMarketConfig = MarketConfig(
  ...
  weatherRequestItems: <String, List<String>>{
    'heatWave': <String>['Tenue ombragée', 'Réflecteur thermique'],
    'heavyRain': <String>['Tenue anti-pluie', 'Couche imperméabilisante'],
    'toxicCloud': <String>['Tenue filtrante', 'Filtre personnel'],
  },
  ...
  requestPriceBioPiles: <String, int>{
    ...
    'Tenue anti-pluie': 20,
    'Tenue filtrante': 25,
    'Couche imperméabilisante': 10,
    'Réflecteur thermique': 10,
    'Filtre personnel': 12,
    'Filtre': 7,
