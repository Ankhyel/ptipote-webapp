...
const PTIPOTE_STATS_FIELDS = [
  ...
  "v3AttachmentDecayPerHour", "v3AttachmentLevelDecayReduction", "v3AttachmentLevelThresholdPercent", "v3AttachmentLevel1Hours", "v3AttachmentLevel2Hours", "v3AttachmentLevel3Hours", "v3HugAttachmentGain", "v3TrainingAttachmentGain", "v3WalkAttachmentGain", "v3TrainingEnergyCost",
...
function ptipoteFieldLabel(field) {
  const labels = {
    ...
    v3AttachmentDecayPerHour: "V3 Attachement · Décroissance / heure", v3AttachmentLevelDecayReduction: "V3 Attachement · Réduction de décroissance par niveau", v3AttachmentLevelThresholdPercent: "V3 Attachement · Seuil de progression (%)", v3AttachmentLevel1Hours: "V3 Attachement N1 · Durée requise (h)", v3AttachmentLevel2Hours: "V3 Attachement N2 · Durée requise (h)", v3AttachmentLevel3Hours: "V3 Attachement N3 · Durée requise (h)", v3HugAttachmentGain: "V3 Attachement · Câlin", v3TrainingAttachmentGain: "V3 Attachement · Entraînement", v3WalkAttachmentGain: "V3 Attachement · Promenade", v3TrainingEnergyCost: "V3 Entraînement · Coût énergie",
...
const ZONE0_SECTION_SOURCES = {
  ...
  ecologyV2: "ecology-v2-config.json",
...
function prettyPath(path) {
  const labels = {
    ...
    specializedShopSlotsByMarketLevel: "Emplacements de magasins spécialisés par niveau de Marché",
...
function renderLisiereEditor() {
  ...
  el.lisiereForageList.innerHTML = [
    ...
    configCard("Écologie physique 0", "ecologyV2", zone0Settings.ecologyV2 || {}, [], { open: true, meta: "Biomasse dérivée, eau, déchets, contamination, Minéral et Mine profonde" }),
